...
function InputPage() {
  ...
  const runInputCommand = (inputValue) => {
    ...
    if (command === "RIGHT" || command === "LEFT") {
      console.log({ command, facing, facingToward });
      // facingToward
    ...
    if (command === "REPORT") {
      ...
      console.log({ axisX, axisY, facing });
      return dispatch(
        setCommand({
      ...
      return console.log("Please check your command");
    }
  };
  return (
    <InputPageContainer>
      <TitleContainer>
        ...
        <Title>Command Here ...</Title> <Campass></Campass>
      </TitleContainer>
